module {
  func.func @main() {
    ...
    %alloc_22 = memref.alloc(%9) {alignment = 32 : i64} : memref<?xf64>
    ...
    linalg.fill ins(%cst_0 : f64) outs(%alloc_22 : memref<?xf64>)
    ...
    // ; Print
    //;call @comet_print_memref_i64(%cast_2) : (memref<*xindex>) -> () //A1pos
    //;call @comet_print_memref_i64(%cast_4) : (memref<*xindex>) -> () //A1crd
    //;call @comet_print_memref_i64(%cast_6) : (memref<*xindex>) -> () //A1blk_pos
    //;call @comet_print_memref_i64(%cast_8) : (memref<*xindex>) -> () //A1blk_crd
    //;call @comet_print_memref_i64(%cast_10) : (memref<*xindex>) -> () //A2pos
    //;call @comet_print_memref_i64(%cast_12) : (memref<*xindex>) -> () //A2crd
    //;call @comet_print_memref_i64(%cast_14) : (memref<*xindex>) -> () //A2blk_pos
    //;call @comet_print_memref_i64(%cast_16) : (memref<*xindex>) -> () //A2blk_crd
    ...
    %cols = memref.load %alloc_1[%c0] : memref<?xindex>
    %rows = memref.load %alloc_13[%c0] : memref<?xindex>
    %cast_19 = memref.cast %alloc_19 : memref<?xf64> to memref<*xf64>
    %cast_22 = memref.cast %alloc_21 : memref<?xf64> to memref<*xf64>
    func.call @ell_test1(%rows, %cols, %cast_12, %cast_18, %cast_19, %cast_22) : (index, index, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>) -> ()
    ...
    %cols2 = memref.load %alloc_1[%c0] : memref<?xindex>
    %rows2 = memref.load %alloc_13[%c0] : memref<?xindex>
    %cast_23 = memref.cast %alloc_22 : memref<?xf64> to memref<*xf64>
    func.call @ell_test2(%rows2, %cols2, %cast_12, %cast_18, %cast_19, %cast_23) : (index, index, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>) -> ()
    
    %213 = call @getTime() : () -> f64
    call @printElapsedTime(%211, %213) : (f64, f64) -> ()
  ...
  func.func private @ell_test1(index, index, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>)
  func.func private @ell_test2(index, index, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>)
}
