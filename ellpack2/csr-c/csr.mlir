module {
  func.func @main() {
    ...
    func.call @csr_test1(%12, %cast_10, %cast_12, %cast_18, %cast_19, %cast_22) : (index, memref<*xindex>, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>) -> ()
  ...
  func.func private @csr_test1(index, memref<*xindex>, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>)
}
