module attributes {llvm.data_layout = ""} {
  ...
  ^bb34:  // pred: ^bb33
    %273 = llvm.load %181 : !llvm.ptr<i64>
    llvm.br ^bb35(%19 : i64)
  ^bb35(%274: i64):  // 2 preds: ^bb34, ^bb36
    %275 = llvm.icmp "slt" %274, %273 : i64
    llvm.cond_br %275, ^bb36, ^bb37
  ^bb36:  // pred: ^bb35
    %276 = llvm.load %61 : !llvm.ptr<i64>
    %277 = llvm.mul %274, %276  : i64
    %278 = llvm.add %277, %271  : i64
    %279 = llvm.getelementptr %161[%278] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %280 = llvm.load %279 : !llvm.ptr<i64>
    %281 = llvm.getelementptr %221[%278] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %282 = llvm.load %281 : !llvm.ptr<f64>
    %283 = llvm.getelementptr %248[%280] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %284 = llvm.load %283 : !llvm.ptr<f64>
    %285 = llvm.getelementptr %260[%271] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %286 = llvm.load %285 : !llvm.ptr<f64>
    %287 = llvm.fmul %282, %284  : f64
    %288 = llvm.fadd %286, %287  : f64
    %289 = llvm.getelementptr %260[%271] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    llvm.store %288, %289 : !llvm.ptr<f64>
    %290 = llvm.add %274, %18  : i64
    llvm.br ^bb35(%290 : i64)
  ^bb37:  // pred: ^bb35
    %291 = llvm.add %271, %18  : i64
