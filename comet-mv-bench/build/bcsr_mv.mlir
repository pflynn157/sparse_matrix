module attributes {llvm.data_layout = ""} {
  ...
  ^bb32:  // pred: ^bb30
    %268 = llvm.call @getTime() : () -> f64
    %269 = llvm.load %60 : !llvm.ptr<i64>
    llvm.br ^bb33(%18 : i64)
  ^bb33(%270: i64):  // 2 preds: ^bb32, ^bb43
    %271 = llvm.icmp "slt" %270, %269 : i64
    llvm.cond_br %271, ^bb34, ^bb44
  ^bb34:  // pred: ^bb33
    %272 = llvm.load %100 : !llvm.ptr<i64>
    llvm.br ^bb35(%18 : i64)
  ^bb35(%273: i64):  // 2 preds: ^bb34, ^bb42
    %274 = llvm.icmp "slt" %273, %272 : i64
    llvm.cond_br %274, ^bb36, ^bb43
  ^bb36:  // pred: ^bb35
    %275 = llvm.load %100 : !llvm.ptr<i64>
    %276 = llvm.mul %270, %275  : i64
    %277 = llvm.add %276, %273  : i64
    %278 = llvm.add %270, %17  : i64
    %279 = llvm.getelementptr %140[%270] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %280 = llvm.load %279 : !llvm.ptr<i64>
    %281 = llvm.getelementptr %140[%278] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
  ...
  ^bb38:  // pred: ^bb37
    %285 = llvm.getelementptr %160[%283] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %286 = llvm.load %285 : !llvm.ptr<i64>
    %287 = llvm.load %180 : !llvm.ptr<i64>
    llvm.br ^bb39(%18 : i64)
  ^bb39(%288: i64):  // 2 preds: ^bb38, ^bb40
    %289 = llvm.icmp "slt" %288, %287 : i64
    llvm.cond_br %289, ^bb40, ^bb41
  ^bb40:  // pred: ^bb39
    %290 = llvm.getelementptr %180[1] : (!llvm.ptr<i64>) -> !llvm.ptr<i64>
    %291 = llvm.load %290 : !llvm.ptr<i64>
    %292 = llvm.mul %286, %291  : i64
    %293 = llvm.add %292, %288  : i64
    %294 = llvm.load %100 : !llvm.ptr<i64>
    %295 = llvm.load %180 : !llvm.ptr<i64>
    %296 = llvm.mul %294, %295  : i64
    %297 = llvm.mul %283, %296  : i64
    %298 = llvm.mul %273, %295  : i64
    %299 = llvm.add %297, %298  : i64
    %300 = llvm.add %299, %288  : i64
    %301 = llvm.getelementptr %220[%300] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %302 = llvm.load %301 : !llvm.ptr<f64>
    %303 = llvm.getelementptr %247[%293] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %304 = llvm.load %303 : !llvm.ptr<f64>
    %305 = llvm.getelementptr %259[%277] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %306 = llvm.load %305 : !llvm.ptr<f64>
    %307 = llvm.fmul %302, %304  : f64
    %308 = llvm.fadd %306, %307  : f64
    %309 = llvm.getelementptr %259[%277] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    llvm.store %308, %309 : !llvm.ptr<f64>
    %310 = llvm.add %288, %17  : i64
    llvm.br ^bb39(%310 : i64)
  ^bb41:  // pred: ^bb39
    %311 = llvm.add %283, %17  : i64
    llvm.br ^bb37(%311 : i64)
  ^bb42:  // pred: ^bb37
    %312 = llvm.add %273, %17  : i64
    llvm.br ^bb35(%312 : i64)
  ^bb43:  // pred: ^bb35
    %313 = llvm.add %270, %17  : i64
    llvm.br ^bb33(%313 : i64)
  ^bb44:  // pred: ^bb33
    %314 = llvm.call @getTime() : () -> f64
    llvm.call @printElapsedTime(%268, %314) : (f64, f64) -> ()
    llvm.return
  }
