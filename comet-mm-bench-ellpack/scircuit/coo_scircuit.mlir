module {
  func.func @main() {
    ...
    %c170998 = arith.constant 170998 : index
    ...
    %alloc_19 = memref.alloc(%10) {alignment = 32 : i64} : memref<?x170998xf64>
    %alloc_20 = memref.alloc(%9) {alignment = 32 : i64} : memref<?x170998xf64>
    linalg.fill ins(%cst : f64) outs(%alloc_19 : memref<?x170998xf64>)
    linalg.fill ins(%cst_0 : f64) outs(%alloc_20 : memref<?x170998xf64>)
    
    scf.for %idx = %c0 to %c10 step %c1 {
        %11 = func.call @getTime() : () -> f64
        %12 = memref.load %alloc_1[%c0] : memref<?xindex>
        %13 = memref.load %alloc_1[%c1] : memref<?xindex>
        scf.for %arg0 = %12 to %13 step %c1 {
          %15 = memref.load %alloc_3[%arg0] : memref<?xindex>
          %16 = memref.load %alloc_11[%arg0] : memref<?xindex>
          scf.for %arg1 = %c0 to %c170998 step %c1 {
            %17 = memref.load %alloc_17[%arg0] : memref<?xf64>
            %18 = memref.load %alloc_19[%16, %arg1] : memref<?x170998xf64>
            %19 = memref.load %alloc_20[%15, %arg1] : memref<?x170998xf64>
            %20 = arith.mulf %17, %18 : f64
            %21 = arith.addf %19, %20 : f64
            memref.store %21, %alloc_20[%15, %arg1] : memref<?x170998xf64>
          }
        }
        %14 = func.call @getTime() : () -> f64
        func.call @printElapsedTime(%11, %14) : (f64, f64) -> ()
    }
