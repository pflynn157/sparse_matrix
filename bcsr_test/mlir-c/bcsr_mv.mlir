module {
  func.func @main() {
    ...
    func.call @bcsr_mv_test(%dense, %rows, %cols, %cast_10, %cast_12, %cast_18, %cast_19, %cast_21) : (index, index, index, memref<*xindex>, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>) -> ()
  ...
  func.func private @bcsr_mv_test(index, index, index, memref<*xindex>, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>)
}
