module {
  func.func @main() {
    ...
    %alloc_19 = memref.alloc(%10) {alignment = 32 : i64} : memref<?x16xf64>
    %alloc_20 = memref.alloc(%9) {alignment = 32 : i64} : memref<?x16xf64>
    linalg.fill ins(%cst : f64) outs(%alloc_19 : memref<?x16xf64>)
    ...
    %cast_19 = memref.cast %alloc_19 : memref<?x16xf64> to memref<*xf64>
    %cast_21 = memref.cast %alloc_20 : memref<?x16xf64> to memref<*xf64>
