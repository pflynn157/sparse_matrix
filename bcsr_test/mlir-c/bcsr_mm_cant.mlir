module {
  func.func @main() {
    ...
    %alloc_19 = memref.alloc(%10) {alignment = 32 : i64} : memref<?x62451xf64>
    %alloc_20 = memref.alloc(%9) {alignment = 32 : i64} : memref<?x62451xf64>
    linalg.fill ins(%cst : f64) outs(%alloc_19 : memref<?x62451xf64>)
    linalg.fill ins(%cst_0 : f64) outs(%alloc_20 : memref<?x62451xf64>)
    
    %k = arith.constant 62451 : index
    
    //; Load params
    %dense = memref.load %alloc_1[%c0] : memref<?xindex>
    %rows = memref.load %alloc_5[%c0] : memref<?xindex>
    %cols = memref.load %alloc_13[%c0] : memref<?xindex>
    %cast_19 = memref.cast %alloc_19 : memref<?x62451xf64> to memref<*xf64>
    %cast_21 = memref.cast %alloc_20 : memref<?x62451xf64> to memref<*xf64>
    func.call @bcsr_mm_test(%dense, %rows, %cols, %cast_10, %cast_12, %cast_18, %cast_19, %cast_21, %k) : (index, index, index, memref<*xindex>, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>, index) -> ()
  ...
  func.func private @bcsr_mm_test(index, index, index, memref<*xindex>, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>, index)
}
