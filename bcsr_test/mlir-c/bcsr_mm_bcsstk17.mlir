module {
  func.func @main() {
    ...
    %cast_19 = memref.cast %alloc_19 : memref<?x10974xf64> to memref<*xf64>
    %cast_21 = memref.cast %alloc_20 : memref<?x10974xf64> to memref<*xf64>
