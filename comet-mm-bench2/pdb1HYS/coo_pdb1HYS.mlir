module {
  func.func @main() {
    ...
    %c36417 = arith.constant 36417 : index
    ...
    scf.for %idx = %c0 to %c10 step %c1 {
        ...
        scf.for %arg0 = %12 to %13 step %c1 {
          ...
          scf.for %arg1 = %c0 to %c36417 step %c1 {
            %17 = memref.load %alloc_17[%arg0] : memref<?xf64>
            %18 = memref.load %alloc_19[%16, %arg1] : memref<?x36417xf64>
            %19 = memref.load %alloc_20[%15, %arg1] : memref<?x36417xf64>
            %20 = arith.mulf %17, %18 : f64
            %21 = arith.addf %19, %20 : f64
            memref.store %21, %alloc_20[%15, %arg1] : memref<?x36417xf64>
          }
        }
