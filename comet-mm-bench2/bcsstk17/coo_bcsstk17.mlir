module {
  func.func @main() {
    ...
    %c10974 = arith.constant 10974 : index
    ...
    scf.for %idx = %c0 to %c10 step %c1 {
        ...
        scf.for %arg0 = %12 to %13 step %c1 {
          ...
          scf.for %arg1 = %c0 to %c10974 step %c1 {
            %17 = memref.load %alloc_17[%arg0] : memref<?xf64>
            %18 = memref.load %alloc_19[%16, %arg1] : memref<?x10974xf64>
            %19 = memref.load %alloc_20[%15, %arg1] : memref<?x10974xf64>
            %20 = arith.mulf %17, %18 : f64
            %21 = arith.addf %19, %20 : f64
            memref.store %21, %alloc_20[%15, %arg1] : memref<?x10974xf64>
          }
        }
