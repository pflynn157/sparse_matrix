module {
  func.func @main() {
    ...
    %cast_22 = memref.cast %alloc_20 : memref<?x32xf64> to memref<*xf64>
    func.call @ell_mm_test2(%rows, %cols, %cast_12, %cast_18, %cast_19, %cast_22, %c32) : (index, index, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>, index) -> ()
