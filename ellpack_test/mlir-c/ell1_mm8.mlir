module {
  func.func @main() {
    ...
    //;        %20 = memref.load %alloc_19[%18, %arg2] : memref<?x8xf64>
    //;        %21 = memref.load %alloc_20[%arg0, %arg2] : memref<?x8xf64>
    //;        %22 = arith.mulf %19, %20 : f64
    //;        %23 = arith.addf %21, %22 : f64
    //;        memref.store %23, %alloc_20[%arg0, %arg2] : memref<?x8xf64>
    //;      }
    //;    }
    //;  }
    ...
    func.call @ell_mm_test1(%rows, %cols, %cast_12, %cast_18, %cast_19, %cast_22, %c8) : (index, index, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>, index) -> ()
