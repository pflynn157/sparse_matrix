module {
  func.func @main() {
    ...
    %alloc_19 = memref.alloc(%10) {alignment = 32 : i64} : memref<?x8xf64>
    %alloc_20 = memref.alloc(%9) {alignment = 32 : i64} : memref<?x8xf64>
    %alloc_21 = memref.alloc(%9) {alignment = 32 : i64} : memref<?x8xf64>
    linalg.fill ins(%cst : f64) outs(%alloc_19 : memref<?x8xf64>)
    linalg.fill ins(%cst_0 : f64) outs(%alloc_20 : memref<?x8xf64>)
    linalg.fill ins(%cst_0 : f64) outs(%alloc_21 : memref<?x8xf64>)
    ...
    //;        %18 = memref.load %alloc_19[%16, %arg2] : memref<?x8xf64>
    //;        %19 = memref.load %alloc_20[%arg1, %arg2] : memref<?x8xf64>
    //;        %20 = arith.mulf %17, %18 : f64
    //;        %21 = arith.addf %19, %20 : f64
    //;        memref.store %21, %alloc_20[%arg1, %arg2] : memref<?x8xf64>
    //;      }
    //;    }
    //;  }
    //;  
    ...
    //;%cast_21 = memref.cast %alloc_20 : memref<?x8xf64> to memref<*xf64>
    ...
    %cast_19 = memref.cast %alloc_19 : memref<?x8xf64> to memref<*xf64>
    %cast_22 = memref.cast %alloc_20 : memref<?x8xf64> to memref<*xf64>
    func.call @ell_mm_test2(%rows, %cols, %cast_12, %cast_18, %cast_19, %cast_22, %c8) : (index, index, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>, index) -> ()
  ...
  func.func private @ell_mm_test2(index, index, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>, index)
}
