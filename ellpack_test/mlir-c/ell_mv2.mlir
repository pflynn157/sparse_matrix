module {
  func.func @main() {
    ...
    func.call @ell_mv_test2(%rows, %cols, %cast_12, %cast_18, %cast_19, %cast_22) : (index, index, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>) -> ()
  ...
  func.func private @ell_mv_test2(index, index, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>)
}
