module {
  func.func @main() {
    ...
    %c1024 = arith.constant 62451 : index
    ...
    %cast_22 = memref.cast %alloc_20 : memref<?x62451xf64> to memref<*xf64>
    func.call @ell_mm_test2(%rows, %cols, %cast_12, %cast_18, %cast_19, %cast_22, %c1024) : (index, index, memref<*xindex>, memref<*xf64>, memref<*xf64>, memref<*xf64>, index) -> ()
