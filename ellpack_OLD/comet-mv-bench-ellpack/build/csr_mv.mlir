module attributes {llvm.data_layout = ""} {
  ...
  ^bb30(%265: i64):  // 2 preds: ^bb28, ^bb31
    ...
    llvm.cond_br %266, ^bb31, ^bb32(%19 : i64)
  ^bb31:  // pred: ^bb30
  ...
  ^bb32(%269: i64):  // 2 preds: ^bb30, ^bb39
    %270 = llvm.icmp "slt" %269, %15 : i64
    llvm.cond_br %270, ^bb33, ^bb40
  ^bb33:  // pred: ^bb32
    %271 = llvm.call @getTime() : () -> f64
    %272 = llvm.load %61 : !llvm.ptr<i64>
    llvm.br ^bb34(%19 : i64)
  ^bb34(%273: i64):  // 2 preds: ^bb33, ^bb38
    %274 = llvm.icmp "slt" %273, %272 : i64
    llvm.cond_br %274, ^bb35, ^bb39
  ^bb35:  // pred: ^bb34
    %275 = llvm.add %273, %18  : i64
    %276 = llvm.getelementptr %141[%273] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %277 = llvm.load %276 : !llvm.ptr<i64>
    %278 = llvm.getelementptr %141[%275] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %279 = llvm.load %278 : !llvm.ptr<i64>
    llvm.br ^bb36(%277 : i64)
  ^bb36(%280: i64):  // 2 preds: ^bb35, ^bb37
    %281 = llvm.icmp "slt" %280, %279 : i64
    llvm.cond_br %281, ^bb37, ^bb38
  ^bb37:  // pred: ^bb36
    %282 = llvm.getelementptr %161[%280] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    %283 = llvm.load %282 : !llvm.ptr<i64>
    %284 = llvm.getelementptr %221[%280] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %285 = llvm.load %284 : !llvm.ptr<f64>
    %286 = llvm.getelementptr %248[%283] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %287 = llvm.load %286 : !llvm.ptr<f64>
    %288 = llvm.getelementptr %260[%273] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    %289 = llvm.load %288 : !llvm.ptr<f64>
    %290 = llvm.fmul %285, %287  : f64
    %291 = llvm.fadd %289, %290  : f64
    %292 = llvm.getelementptr %260[%273] : (!llvm.ptr<f64>, i64) -> !llvm.ptr<f64>
    llvm.store %291, %292 : !llvm.ptr<f64>
    %293 = llvm.add %280, %18  : i64
    llvm.br ^bb36(%293 : i64)
  ^bb38:  // pred: ^bb36
    llvm.br ^bb34(%275 : i64)
  ^bb39:  // pred: ^bb34
    %294 = llvm.call @getTime() : () -> f64
    llvm.call @printElapsedTime(%271, %294) : (f64, f64) -> ()
    %295 = llvm.add %269, %18  : i64
    llvm.br ^bb32(%295 : i64)
  ^bb40:  // pred: ^bb32
    llvm.return
  }
