...
219:                                              ; preds = %244, %216
  %220 = phi i64 [ %223, %244 ], [ 0, %216 ]
  %221 = icmp slt i64 %220, %218
  br i1 %221, label %222, label %245

222:                                              ; preds = %219
  %223 = add i64 %220, 1
  %224 = getelementptr i64, ptr %100, i64 %220
  %225 = load i64, ptr %224, align 4
  %226 = getelementptr i64, ptr %100, i64 %223
  %227 = load i64, ptr %226, align 4
  br label %228

228:                                              ; preds = %231, %222
  %229 = phi i64 [ %243, %231 ], [ %225, %222 ]
  %230 = icmp slt i64 %229, %227
  br i1 %230, label %231, label %244

231:                                              ; preds = %228
  %232 = getelementptr i64, ptr %117, i64 %229
  %233 = load i64, ptr %232, align 4
  %234 = getelementptr double, ptr %168, i64 %229
  %235 = load double, ptr %234, align 8
  %236 = getelementptr double, ptr %191, i64 %233
  %237 = load double, ptr %236, align 8
  %238 = getelementptr double, ptr %200, i64 %220
  %239 = load double, ptr %238, align 8
  %240 = fmul double %235, %237
  %241 = fadd double %239, %240
  %242 = getelementptr double, ptr %200, i64 %220
