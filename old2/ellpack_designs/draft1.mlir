module {
  func.func @main() {
    ...
    %3 = "ta.sparse_tensor_decl"(%1, %2) {format = "ELL", temporal_tensor = false} : (!ta.range, !ta.range) -> tensor<?x?xf64>
    ...
    "ta.fill"(%4) {value = 1.700000e+00 : f64} : (tensor<4x?xf64>) -> ()
    ...
    %6 = "it.ComputeRHS"(%4, %3) {allFormats = [["D", "D"], ["D", "S"]], allBlocks = [["UNK", "UNK"], ["D", "UNK"]], allPerms = [[0, 1], [1, 2]]} : (tensor<4x?xf64>, tensor<?x?xf64>) -> tensor<*xf64>
    %7 = "it.ComputeLHS"(%5) {allFormats = [["D", "D"]], allPerms = [[0, 2]]} : (tensor<4x?xf64>) -> tensor<*xf64>
